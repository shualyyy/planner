...
function CheckSvg({ stroke = '#1C1917' }: { stroke?: string }) {
  return (
      ...
      >
        ...
        <div style={{ padding: '12px 22px 0', flexShrink: 0 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between' }}>
            <div style={{ font: '300 28px/1 var(--font-sans)', color: '#F0ECE3' }}>Habits</div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
              <span style={{ font: '400 12px/1.2 var(--font-sans)', color: 'rgba(255,255,255,0.4)' }}>{MONTHS_EN[today.getMonth()]} {today.getFullYear()}</span>
              <button onClick={onClose} style={{ width: 30, height: 30, borderRadius: '50%', background: '#2D2926', color: 'rgba(255,255,255,0.6)', display: 'flex', alignItems: 'center', justifyContent: 'center', border: 'none', cursor: 'pointer' }}>
